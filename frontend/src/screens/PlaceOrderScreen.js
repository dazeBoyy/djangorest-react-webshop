                  ...
                  {cart.cartItems.map((item, index) => (
                    <ListGroup.Item key={index}>
                      <Row>
                        ...
                        <Col md={4}>
                          Кол-во: {item.qty} за  {item.price} =
                           { ( item.qty * item.price).toFixed(2)} рублей
                        </Col>
                      </Row>
                    </ListGroup.Item>
                  ))}
            ...
            <ListGroup variant="flush">
              ...
              <ListGroup.Item>
                <Row>
                  ...
                  <Col>{cart.itemsPrice} рублей</Col>
                </Row>
              </ListGroup.Item>

              <ListGroup.Item>
                <Row>
                  <Col>Цена доставки:</Col>

                  <Col>{cart.shippingPrice} рублей</Col>
                </Row>
              </ListGroup.Item>
              ...
              <ListGroup.Item>
                <Row>
                  ...
                  <Col>{cart.totalPrice} рублей</Col>
                </Row>
              </ListGroup.Item>
              ...
              <ListGroup.Item>
                <PayButton className="w-100 primary" type="button"  cartItems={cart.cartItems}> Оформить заказ</PayButton>
              </ListGroup.Item>
            </ListGroup>
          </Card>
        </Col>
